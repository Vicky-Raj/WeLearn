    ...
    if(value.length <= 0){
        ...
        request.onload = ()=>{
            ...
            if(response['added']){
                ...
                var temp_comment = newComment.children[0].children[0].children[0];
                newComment.setAttribute('id',`comment-set-${response['pk']}`);
                temp_comment.children[4].innerHTML = value;
                temp_comment.children[5].children[1].setAttribute('id',`comment-up-${response['pk']}`);
                temp_comment.children[5].children[1].children[0].setAttribute('onclick',`comment_like(${response['pk']})`);
                temp_comment.children[5].children[1].children[1].setAttribute('id',`comment-up-count-${response['pk']}`);
                newComment.children[1].setAttribute('id',`reply-section-${response['pk']}`);
                temp_comment.children[4].setAttribute('id',`comment-content-${response['pk']}`);
                temp_comment.children[5].children[0].setAttribute('id',`comment-edited-${response['pk']}`);
                temp_comment.children[0].children[1].children[0].setAttribute('onclick',`comment_edit_start(${response['pk']})`);
                temp_comment.children[5].children[2].children[0].setAttribute('id',`reply-btn-${response['pk']}`);
                temp_comment.children[5].children[2].children[0].setAttribute('onclick',`reply_start(${response['pk']})`);
                temp_comment.children[0].children[0].children[0].setAttribute('onclick',`comment_delete(${response['pk']})`);
